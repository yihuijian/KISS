...
@TargetApi(17)
// Source: https://github.com/hundeva/Lean-Launcher/blob/o-mr1/src/com/hdeva/launcher/LeanTimeoutActivity.java
public class ScreenLockActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG, "Error writing Settings.System.SCREEN_OFF_TIMEOUT");
        }
        try {
            Settings.System.putInt(getContentResolver(), Settings.Global.STAY_ON_WHILE_PLUGGED_IN, 0);
        } catch (Throwable t) {
            Log.e(TAG, "Error writing Settings.Global.STAY_ON_WHILE_PLUGGED_IN");
        }
    }
